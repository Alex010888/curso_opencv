...
Si quieres practicar un poco más con la representación 
de distintos colores sobre una imagen creada con numpy
 te dejo el siguiente programa que puedes analizar:
"""
import cv2
import numpy as np
